 ...
 * @dev Clase padre con informacion de las votaciones.
 */
contract BallotHelper {
    enum State {
        ...
        Voting,
        Ended
    } /// Para ver el estado de la votacion actual
    ...
    modifier inState(State _state) {
        /// Para confirmar desde el enum de Stat que este en creado, en proceso, o terminado.
